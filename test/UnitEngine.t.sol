...
contract GameEngineTest is BaseSetup {
    ...
    function test_dropChance100() public view {
        assertEq(engine.dropChanceBps(), 10000);
    }
    ...
    function test_setDropChanceRevertOver10000() public {
        vm.prank(deployer);
        vm.expectRevert("Max 10000 bps");
        engine.setDropChance(10001);
    }
